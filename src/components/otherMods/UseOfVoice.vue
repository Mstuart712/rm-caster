<template>
  <div class="mod-container">
    <h6 class="card-title">Use of Voice</h6>
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <ul class="dropdown-menu">
                <li v-for="item, index in voiceUsed" :key="item.title">
...
export default {
  ...
  setup(props) {
    ...
    const modAccess = "voiceUsed";
    const voiceUsed = props.voiceUsed.tableList;
    const currentSelection = reactive({ result: "Use of Voice" });
    ...
    const calcMod = (index) => {
      state.result = props.voiceUsed.tableList[index].modifiers[currentCharacter.casterTypeIndex];
    ...
    function setModifier(index) {
      ...
      this.currentSelection.result = props.voiceUsed.tableList[index].title;
      calcMod(index)
    }

    const initComponent = async () => {
      if(getSpellMod(props.characterId, modAccess) != null) {
        currentSelection.result = props.voiceUsed.tableList[getSpellMod(props.characterId, modAccess)].title;   
